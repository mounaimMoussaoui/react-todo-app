   ...
   return (<section data-testid={"Signup"}>
       ...
       <form className={`${styles.container} ${styles.formContainer}`} onSubmit={handleSubmit}>
           <div aria-label={"group-form"} className={`${styles.groupForm}`}>
               ...
               { errors.identifier && touched.identifier ? <FaTimes aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackErrors}`}/> : <FaCheck aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackValid}`}/>}
           ...
           <div aria-label={"group-form"} className={`${styles.groupForm}`}>
               ...
               { errors.fullName && touched.fullName ? <FaTimes aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackErrors}`}/> : <FaCheck aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackValid}`}/>}
           ...
           <div aria-label={"group-form"} className={`${styles.groupForm}`}>
               ...
               { errors.email && touched.email ? <FaTimes aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackErrors}`}/> : <FaCheck aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackValid}`}/>}
           ...
           <div aria-label={"group-form"} className={`${styles.groupForm}`}>
               ...
               { errors.password && touched.password ? <FaTimes aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackErrors}`}/> : <FaCheck aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackValid}`}/>}
           ...
           <div aria-label={"group-form"} className={`${styles.groupForm}`}>
               ...
               { errors.confirmPassword && touched.confirmPassword ? <FaTimes aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackErrors}`}/> : <FaCheck aria-hidden="true"  className={`${styles.icon} ${styles.iconFeedBack} ${styles.iconFeedBackValid}`}/>}
           ...
           <motion.button
               ...
               className={styles.styleBtn} aria-label={'Button To Sing Up In The Todo App'} type={"submit"}><VscSignIn aria-hidden="true" /><span>Sign Up</span>
           </motion.button>
